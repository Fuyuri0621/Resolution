...
public class MissionManager : MonoBehaviour
{
    ...
    public void SwitchMissionByName(string id)
    {
        nowMissionID = missionTable.MissionList.FindIndex(x => x.id == id);
        UpdateMissioninfo();
    }
    public void AccomplishMission()
    {
        ...
        if (missionTable.MissionList[nowMissionID].onAccomplish != null) { missionTable.MissionList[nowMissionID].onAccomplish.Invoke(); }
    ...
    public string GetMissionName(int missionid) { return missionTable.MissionList[missionid].MissionName;  }

    public MissionTableItem GetNowMission() { return missionTable.MissionList[nowMissionID]; }
